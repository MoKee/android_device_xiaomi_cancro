...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/mixer_paths_3_1.xml:system/etc/mixer_paths_3_1.xml \
    $(LOCAL_PATH)/audio/mixer_paths_3_1_forte.xml:system/etc/mixer_paths_3_1_forte.xml \
    $(LOCAL_PATH)/audio/mixer_paths_3_2.xml:system/etc/mixer_paths_3_2.xml \
    $(LOCAL_PATH)/audio/mixer_paths_3_2_forte.xml:system/etc/mixer_paths_3_2_forte.xml \
    $(LOCAL_PATH)/audio/mixer_paths_4_x.xml:system/etc/mixer_paths_4_x.xml \
    $(LOCAL_PATH)/audio/mixer_paths_4_x_forte.xml:system/etc/mixer_paths_4_x_forte.xml \
    ...
    $(LOCAL_PATH)/audio/mixer_paths_auxpcm_3_1.xml:system/etc/mixer_paths_auxpcm_3_1.xml \
    $(LOCAL_PATH)/audio/mixer_paths_auxpcm_3_2.xml:system/etc/mixer_paths_auxpcm_3_2.xml \
    $(LOCAL_PATH)/audio/mixer_paths_auxpcm_4_x.xml:system/etc/mixer_paths_auxpcm_4_x.xml \
