...
void _ZN7android13SensorManagerC1Ev(void *sensorMgr)
{
    ...
    _ZN7android8String16C1EPKc(&string, "camera.vendor.msm8974");
...
{
    ALOGI("msm8974 camera interposition library loaded. Your camera should work in M now.");
}
...
{
    ALOGI("msm8974 camera interposition library unloading. Goodbye...");
